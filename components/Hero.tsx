  ...
  return (
    <div className="h-screen w-full relative ">
      ...
      <div className='flex flex-col absolute mt-64 md:mt-96 w-4/5 md:w-3/4 md:ps-20  gap-y-6 md:gap-y-12 px-6 md:px-0'>
        <h1 className='font-monument font-extrabold text-3xl md:text-5xl uppercase tracking-widest'>The world&aposs first platform for Tokenizing AI blockchain projects</h1>
